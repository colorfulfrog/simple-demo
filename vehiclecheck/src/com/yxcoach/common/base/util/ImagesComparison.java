...
public final class ImagesComparison {
	/**
    ...
    public ImagesComparison(byte[] hashValue) {
    ...
    public ImagesComparison(String hashValue) {
        this(toBytes(hashValue));
    }
    public ImagesComparison (BufferedImage src){
        this(hashValue(src));
    }
     ...
     * @return
     */
    public static ImagesComparison createFromCompact(byte[] compactValue){
        return new ImagesComparison(uncompact(compactValue));
    }
    ...
    public boolean equals(Object obj) {
        if(obj instanceof ImagesComparison){
            return Arrays.equals(this.binaryzationMatrix,((ImagesComparison)obj).binaryzationMatrix);
        }else
    ...
    public float compare(String hashValue){
        return compare(new ImagesComparison(hashValue));
    }
    /**
     * 与指定的指纹比较相似度
     * @param hashValue
    ...
    public float compare(BufferedImage image2){
        return compare(new ImagesComparison(image2));
    }
    /**
     * 比较指纹相似度
     * @param src
     ...
     */
    public float compare(ImagesComparison src){
    ...
    public static float compare(BufferedImage image1,BufferedImage image2){
        return new ImagesComparison(image1).compare(new ImagesComparison(image2));
    }
    ...
    public static void main(String[] args) throws Exception {
    	ImagesComparison fp1; 
    	ImagesComparison fp2;
    	InputStream is=null;
		try {
//			BufferedImage a=getImg("http://treasure123.oss-cn-beijing.aliyuncs.com/treasure/b589061a-c8b0-4446-b240-7162c1d7341f.jpg");
			fp1= new ImagesComparison(ImageIO.read(is));
			fp1= new ImagesComparison(getImg("http://treasure123.oss-cn-beijing.aliyuncs.com/treasure/b589061a-c8b0-4446-b240-7162c1d7341f.jpg"));
			fp2 = new ImagesComparison(getImg("http://treasure123.oss-cn-beijing.aliyuncs.com/treasure/b589061a-c8b0-4446-b240-7162c1d7341f.jpg"));
