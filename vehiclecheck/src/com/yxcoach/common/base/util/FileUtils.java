...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	public static String getSuffix(String fileName){
		...
		return fileName.substring(idx);//返回.txt
	}
	/**
	 * 用于创建、删文件
	 * @param path
	 ...
	 * @return
	 */
	public static boolean fileOper(String path, String fileName, InputStream is, boolean tag) {
