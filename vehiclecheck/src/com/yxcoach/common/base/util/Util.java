...
public class Util { 
	...
	/**手机号正则*/
	private static final String REG_MOBILE = "^((\\+86)|(86))?(13|14|15|18|17)+\\d{9}$";
	//private static final String REG_MOBILE = "^(13[0-9]|14[579]|15[0-3,5-9]|16[6]|17[0135678]|18[0-9]|19[89])\\d{8}$";
	 ...
	 * @throws Exception
	 */
	public static void isNullError(Object o,String param) throws Exception{
		if(Util.isNull(o)){
			throw new YxBizException(param+"不能为空");
		}
	}
	/***
	 * 验证参数不为空错误
	 ...
	 * @throws Exception
	 */
	public static void isNotNullError(Object o,String param) throws Exception{
		if(Util.isNotNull(o)){
			throw new YxBizException(param+"参数不能传递");
		}
	}
	/***
	 * 验证手机号
	 ...
	 * @throws Exception
	 */
	public static void isMobileError(String s,String param) throws Exception{
		isNullError(s,param);
		if(!Util.isMobile(s)){
			throw new YxBizException(param+"不是合法的手机号");
		}
	}
	/***
	 * 验证车牌号
	 ...
	 * @throws Exception
	 */
	public static void isPlateNumError(String s,String param) throws Exception{
		isNullError(s,param);
		if(!Util.isPlateNum(s)){
			throw new YxBizException(param+"不是合法的车牌号，如：湘A88888");
		}
	}
	/***
	 * 验证身份证号或驾驶证号
	 ...
	 * @throws Exception
	 */
	public static void isCIDNumError(String s,String param) throws Exception{
		isNullError(s,param);
		if(!Util.isCIDNum(s)){
			throw new YxBizException(param+"不是合法的身份证或驾驶证号");
		}
	}
	/***
	 * 验证Integer数字大小范围>=ag0并且<=arg1	 *
	 * @throws Exception
	 */
	public static void isIntBtwError(Integer num,String param,Integer arg0,Integer arg1) throws Exception{
		isNullError(num,param);
		if(!(num>=arg0&&num<=arg1)){
			throw new YxBizException(param+"不是合法数字，范围："+arg0+"-"+arg1);
		}
	}
	/***
	 * 验证Double数字大小范围>=ag0并且<=arg1	 *
	 * @throws Exception
	 */
	public static void isDoubleError(Double num,String param) throws Exception{
		isNullError(num,param); 
		if(num<=0){
			throw new YxBizException(param+"不是合法数字:必须大于零");
		}
	}
     ...
     * @return
     */
	public static Float round(Float ft, int scale) {
